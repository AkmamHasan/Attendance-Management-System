		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String dbin2= "INSERT INTO user_information VALUES('"+studentid01+"','"+stpassword+"','"+role_s+"')"; 
					stmt.execute(dbin2);
					stmt.close();
				...
				java.sql.Statement stmt = con.createStatement();
				String dbin1= "INSERT INTO student VALUES('"+studentid+"','"+stfname+"','"+stlname+"','"+staddress+"','"+stcity+"','"+stpostalcode+"','"+stmobileno+"','"+stemail+"','"+studentid+"')";
				...
				textField_8.setText("");
					...
					JOptionPane.showMessageDialog(null, "Acc Already Exist or check- Mobilenumber and postal code must contain 11 digits and 4 digits");}
		...
		btnCreateFacultyProfile.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					java.sql.Statement stmt = con.createStatement();
					String dbin2= "INSERT INTO user_information VALUES('"+facultyidid01+"','"+fpassword+"','"+role_f+"')"; 
					stmt.execute(dbin2);
					stmt.close();
				...
				java.sql.Statement stmt = con.createStatement();
				String dbin5= "INSERT INTO faculty_information VALUES('"+facultyid02+"','"+fname+"','"+fdepartment+"','"+fmobileno+"','"+femail+"','"+facultyid02+"')";
		...
		btnCreateCourse.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					java.sql.Statement stmt = con.createStatement();
					String dbin2= "INSERT INTO course_information VALUES('"+courseid01+"','"+courseinitial+"','"+coursename+"','"+semester+"','"+year+"','"+section+"','"+facultyid02+"')"; 
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					java.sql.Statement stmt = con.createStatement();
					String dbin3= "INSERT INTO student_has_course_information VALUES('"+studentid05+"','"+courseid05+"','"+courseinitial05+"','"+facultyid05+"')"; 
